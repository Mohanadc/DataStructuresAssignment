...
public class UnsortedTableMap<K, V> extends AbstractMap<K, V> {
    ...
    public V get(K key) {
        for(MapEntry<K, V> c: table)
        {
            //System.out.println("found " + c.getKey());
            if(c.getKey().equals(key)) {
                //System.out.println("returning " + c.getKey());
                return c.getValue();
            }
        }
        return null;
    ...
    public V put(K key, V value) {
        ...
        valueToReturn = table.get(index).getValue();
    ...
    public V remove(K key) {
        ...
        valueToRemove = table.get(index).getValue();
        table.remove(index);
