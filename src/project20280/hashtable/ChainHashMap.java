...
public class ChainHashMap<K, V> extends AbstractHashMap<K, V> {
    ...
    protected V bucketPut(int h, K k, V v) {
        ...
        V valueToReturn = bucket.put(k,v);
    ...
    protected V bucketRemove(int h, K k) {
        ...
        V valueToReturn = bucket.remove(k);
    ...
    public static void main(String[] args) {
        ...
        m.put(10, "Ten");
        m.put(11, "Eleven");
        System.out.println(m.put(20, "Twenty"));
        System.out.println(m.put(20, "Twenty"));
        ...
        map.put(Integer.toString(5), 5);
        /*System.out.println(map);
        System.out.println(map.get(Integer.toString(5)));
        System.out.println(map.put("disaw", 90));
        System.out.println(map.get("disaw"));*/
    }
}
