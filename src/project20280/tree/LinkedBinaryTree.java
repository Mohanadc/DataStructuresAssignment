...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
    ...
    public E set(Position<E> p, E e) throws IllegalArgumentException {
        Node<E> nodeToChange = validate(p);
        E replacedElement = nodeToChange.getElement();
        nodeToChange.setElement(e);
    ...
    public void attach(Position<E> p, LinkedBinaryTree<E> t1, LinkedBinaryTree<E> t2) throws IllegalArgumentException {
        Node<E> nodeToAttach = validate(p);

        if(isInternal(nodeToAttach))
            throw new IllegalArgumentException("Node is internal");

        size += t1.size() + t2.size();

        if(!t1.isEmpty()) {
            nodeToAttach.setLeft(validate(t1.root()));
            t1.root.setParent(root);
            t1.root = null;
            t1.size = 0;
        }
        if(!t2.isEmpty()) {
            nodeToAttach.setRight(validate(t2.root()));
    ...
    public E remove(Position<E> p) throws IllegalArgumentException {
        ...
        E dataRemoved = nodeToRemove.getElement();
        ...
        if(child != null){
            ...
            if (nodeToRemove == root){
                ...
                if(nodeToRemove == child.getParent().getLeft())
